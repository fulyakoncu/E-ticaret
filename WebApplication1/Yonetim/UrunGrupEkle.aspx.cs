        ...
        protected void btnKaydet_Click(object sender, EventArgs e)
        {
            try
            {
                using (cUrunGenel UG = new cUrunGenel())
                {
                    ...
                    if(sonuc>0)
                        UIAraclari.toastMesaj(this, eStatusType.Onay, "İşleminiz Başarı ile Gerçekleşti");
                    else
                        UIAraclari.toastMesaj(this, eStatusType.Hata, "Herhangi bir değişiklik yapılmadı");
                }
            }
            catch (Exception ex)
            {
